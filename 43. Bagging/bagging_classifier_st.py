...
#bootstrap_samples_bool = bootstrap_samples == 'True'
...
if st.sidebar.button('Run Algorithm'):
    ...
    bag_clf = BaggingClassifier(estimator
        ...
        max_samples=max_samples, bootstrap=bool(bootstrap_samples),max_features=max_features,bootstrap_features=bool(bootstrap_features), random_state=42)
